 ...
 */
int
_pty_sharp_set_size(int master, int columns, int rows)
{
	struct winsize size;
	int ret;
 ...
 */
int
_pty_sharp_get_size(int master, int *columns, int *rows)
{
	struct winsize size;
	int ret;
	memset(&size, 0, sizeof(size));
 ...
 */
int
_pty_sharp_open(pid_t *child, char **env_add,
